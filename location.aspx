...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
   ...
   <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" 
            ...
            style="margin-top: 2px; margin-left: 97px; margin-right: 18px;" 
...
Ad,s To Display..."></asp:Label></FooterTemplate>
            <ItemTemplate>
                ...
                <br />
                <br />
                <table style="width: 78%; margin-left: 25px; height: 201px; margin-bottom: 0px;">
                    <tr>
                        <td class="style35">
                            <b>Category</b>&nbsp;</td>
                        <td class="style36">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [post_ads] WHERE ([city] = ?)">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="city" Name="city" 
                SessionField="city" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    </form>
</body>
